...
def rerank(
    ...
    if method == "cross_encoder":
        ...
        # candidates ở đây là 1 list đã gộp sẵn (vd. từ Task 9) — RRF xử lý
        # nó như 1 ranker duy nhất. Nếu cần fuse nhiều ranker, gọi rerank_rrf
        # trực tiếp với list[list[dict]].
